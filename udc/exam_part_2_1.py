...
def stirling(num_of_items,num_of_sets):
    if num_of_items==num_of_sets or num_of_sets==1:
        return 1
    elif num_of_sets>num_of_items:
        return 0
    return num_of_sets*stirling(num_of_items-1,num_of_sets)+stirling(num_of_items-1,num_of_sets-1)
